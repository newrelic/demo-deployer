...
|---|---|---|
| [Hello](catalog/hello.aws.json) | A single-page web application with New Relic instrumentation | [Deploying your first app](https://developer.newrelic.com/automate-workflows/automated-tagging) |
| [Acme Telco Lite](catalog/telcolite.aws.json) | A microservice architecture for a mock eCommerce platform, with simulated issues for investigating | [Use New Relic to diagnose problems in Acme Telco Lite](https://developer.newrelic.com/automate-workflows/diagnose-problems/diagnose-problems)
