      ...
      module Ec2
        class Ec2TemplateContext < TemplateContext
          ...
          def get_template_binding()
            ...
            template_context[:instance_role] = get_resource().get_instance_role()
            template_context[:user_data] = get_resource().get_user_data()
          ...
          def parse_credential(template_context, credential)
            ...
            template_context[:aws_session_token] = credential.get_session_token()
