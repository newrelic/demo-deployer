...
require "./src/provision/templates/gcp/compute/compute_template_builder"
    ...
    module Gcp
      class TemplateFactory
        ...
        def initialize(template_path, supported_types = nil, type_repository = nil)
          ...
          @template_root_path = template_path +"/gcp"
        end
        ...
        def get_supported()
          @supported_types ||= {
            "compute" => Provision::Templates::Gcp::Compute::ComputeTemplateBuilder
          }
        end
